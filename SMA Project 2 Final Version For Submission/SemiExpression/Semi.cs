 ...
 * semi.close();                      // closes file streamC:\Users\sbnighut\Desktop\Final SMA - Swapnil Nighut\SMA Project 2 Final Version For Submission\SemiExpression\Semi.cs
...
namespace CSsemi
{
    ...
    public class CSemiExp
    {
        ...
        string currTok = "";
        string prevTok = "";
        private string functionArguments = string.Empty;

        public string FunctionArguments
        {
            get { return functionArguments; }
            set { functionArguments = value; }
        }

        public List<string> CompleteExpression
        {
            get { return completeExpression; }
            set { completeExpression = value; }
        }

        public List<string> SemiExp
        {
            get { return semiExp; }
            set { semiExp = value; }
        }
        ...
        public CSemiExp()
        {
            ...
            returnNewLines = true;
            completeExpression = new List<string>();
        ...
        /// <summary>
        /// This method will remove a string from the the semi expression based on the index passed
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// This method will remove a token from the semi-expression
        /// </summary>
        ...
        /// <summary>
        /// This method will compare a string with each string in semiexpression and returns a collection of indexes corresponding to them
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public List<int> Complexity_Occur(string str)
        {
